...
!(function (e, t) {
      ...
      return (
        ...
        (u.list = function (e) {
          ...
          if (t) {
            ...
            (h = p ? "\\d{1,9}\\" + h.slice(-1) : "\\" + h),
              this.options.pedantic && (h = p ? h : "[*+-]");
            for (
              var F = new RegExp(
                "^( {0,3}" + h + ")((?: [^\\n]*| *)(?:\\n[^\\n]*)*(?:\\n|$))"
              );
        ...
        (u.autolink = function (e, t) {
          ...
          if (r)
            return (
              (n =
                "@" === r[2]
                  ? "mailto:" + (u = c(this.options.mangle ? t(r[1]) : r[1]))
                  : (u = c(r[1]))),
              {
                type: "link",
                raw: r[0],
              ...
              (u = this.lexer.state.inRawBlock
                ? this.options.sanitize
                  ? this.options.sanitizer
                    ...
                    : c(n[0])
                  : n[0]
                : c(this.options.smartypants ? t(n[0]) : n[0])),
  ...
  var I = (function () {
      function u(t) {
        ...
        this.options.pedantic
          ? ((u.block = $.pedantic), (u.inline = S.pedantic))
          : this.options.gfm &&
            ((u.block = $.gfm),
            this.options.breaks ? (u.inline = S.breaks) : (u.inline = S.gfm)),
          ...
          for (; e; )
            if (
              ...
              if ((u = this.tokenizer.escape(e)))
                ...
                (e = e.substring(u.raw.length)), t.push(u);
              else if ((u = this.tokenizer.autolink(e, R)))
                (e = e.substring(u.raw.length)), t.push(u);
            ...
            e.extensions.forEach(function (e) {
              ...
              if (e.renderer) {
                ...
                i.renderers[e.name] = t
                  ? function () {
                      for (
                        var u = arguments.length, n = new Array(u), r = 0;
                        r < u;
                        r++
                      )
                        n[r] = arguments[r];
          ...
          r = function () {
            ...
            switch ((t.call(j, e), e.type)) {
              ...
              default:
                ...
                j.defaults.extensions.childTokens[e.type]
                  ? j.defaults.extensions.childTokens[e.type].forEach(function (
                      u
                    ) {
                      j.walkTokens(e[u], t);
                    })
